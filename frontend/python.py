...
def handle_referral_link(update: Update, context: CallbackContext) -> None:
    ...
    if 'start' in query_params:
        ...
        referral_link = f"https://t.me/freelancetonbot?start=r{user_id}"
        ...
        update.message.reply_text(f"Welcome! Visit our web app: https://tonfreelance.ru/")
...
def main() -> None:
    ...
    updater = Updater("7259852324:AAEh52fEhy-2s1kN7s77inQQW7CavzIt6eU", use_context=True)
