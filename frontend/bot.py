...
# Configuration
TOKEN = '7259852324:AAEh52fEhy-2s1kN7s77inQQW7CavzIt6eU'
MONGO_URI = ""
WEB_APP_BASE_URL = 'https://tonfreelance.ru/'
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    try:
        ...
        referral_link = f"https://t.me/freelancetonbot?start={user_data['referral_code']}"
        short_referral_link = await generate_short_link(referral_link)

        message = (
            f"🚀 Welcome to TON Freelance Crypto Project, {username}!\n"
        ...
        keyboard = [
            ...
            [InlineKeyboardButton("🌍 Visit Our Website", url="https://tonfreelance.ru/")],
            [InlineKeyboardButton("📢 Join Our Telegram", url="https://t.me/freelancetonch")],
            [InlineKeyboardButton("🐦 Follow Us on Twitter", url="https://twitter.com/freelanceton")]
        ]
