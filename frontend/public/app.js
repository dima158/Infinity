...
const tasks = [
    { id: 11, name: 'Follow on Twitter', url: 'https://x.com/freelanceton', points: 50, icon: 'fab fa-twitter' },
    { id: 12, name: 'Join INFC Telegram', url: 'https://t.me/freekancetonch', points: 50, icon: 'fab fa-telegram' },
    { id: 13, name: 'Visit Website', url: 'https://freelanceton.ru', points: 50, icon: 'fas fa-globe' }
];
...
function generateReferralLink(userId) {
    const baseUrl = "https://t.me/freelancetonbot/app?startapp=";
