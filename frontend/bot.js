...
const token = '7259852324:AAEh52fEhy-2s1kN7s77inQQW7CavzIt6eU';
const bot = new TelegramBot(token, { polling: true });
const uri = "mongodb+srv://dolotiudima:0731163340Dima@cluster0.w1z2gnx.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
const client = new MongoClient(uri);
const webAppBaseUrl = 'https://tonfreelance.ru/';
...
bot.onText(/\/start/, async (msg) => {
  ...
  try {
    ...
    const referralLink = `https://t.me/freelancetonbot?start=${user.referralCode}`;
    const webAppUrl = generateWebAppUrl(msg.from);
    const message = `🚀 Welcome to TON Freelance Project, ${username}!\n\n📊 Points: ${user.points}\n💰 Earn 100 points per referral!\n✨ Start your crypto journey now!`;
    const keyboard = {
      keyboard: [
